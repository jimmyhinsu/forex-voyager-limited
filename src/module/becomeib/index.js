                ...
                <div className='container'>
                    <div className='partnerib-back-img'>
                        <div className='section-st'>
                            <h1 data-aos="fade-down">Team up with Forex Voyeger as a partner(IB)
                                and let's make things awesome together!</h1>
                            <p data-aos="fade-right">Forex Voyeger Introducing Broker (IB) Program Rewards Individuals & Businesses for Introducing New Clients.</p>
