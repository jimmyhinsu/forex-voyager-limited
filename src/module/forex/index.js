              ...
              <div className="product-buttons-changer">
                <Link to={"/Forex"}>
                  <button
                    ...
                    className={activeButton === "Forex" ? "activebutton" : ""}
                  >
                    Forex
                  </button>
                </Link>
                <Link to={"/metals"}>
                  <button
                    onClick={() => handleButtonClick("Metals")}
                    className={activeButton === "Metals" ? "activebutton" : ""}
                  >
                    Metals
                  </button>
                </Link>
                <Link to={"/shares"}>
                  <button
                    ...
                    className={activeButton === "Shares" ? "activebutton" : ""}
                  >
                    Shares
                  </button>
                </Link>
                <Link to={"/indices"}>
                  <button
                    onClick={() => handleButtonClick("Indices")}
                    className={activeButton === "Indices" ? "activebutton" : ""}
                  >
                    Indices
                  </button>
                </Link>
                <Link to={"/commodities"}>
                  <button
                    ...
                    className={
                      activeButton === "Commodities" ? "activebutton" : ""
                    }
                  >
                    Commodities
                  </button>
                ...
                <Link to={"/cryptocurrencies"}>
                  <button
                    onClick={() => handleButtonClick("Digital Assets")}
                    className={
                      activeButton === "Digital Assets" ? "activebutton" : ""
                    }
                  >
                    Digital Assets
                  </button>
            ...
            <div className="product-content">
              {activeButton === "Forex" && (
                <div className="content-forex">
                  ...
                  <p data-aos="fade-down">
                    Take advantage of the narrowest spreads in the market as you
                    trade over 55 main, cross, and exotic Forex pairs.
                  </p>
                  <div
                    className="up-and-down-boxes-changer"
                    id="up-and-down-boxes-changer-web"
                  >
              ...
              {activeButton === "Forex" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer"
                    id="up-and-down-boxes-changer-mobile"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">Up to 1:500</h3>
                      <span data-aos="fade-down">
              ...
              {activeButton === "Metals" && (
                <div className="content-metals">
                  ...
                  <p data-aos="fade-down">
                    By trading metals like gold and silver, you may diversify
                    your portfolio and uncover fresh trading opportunities. With
                    an unmatched global network of the most well-known
                    producers, traders, buyers, and speculators in the precious
                    metals market, Forex Voyager Limited offers unparalleled
                    expertise for seamless trading.
                  </p>
                  <div
                    className="up-and-down-boxes-changer-sc"
                    id="up-and-down-boxes-changer-web-metals"
                  >
                    <div className="up-and-down-box-changer">
              ...
              {activeButton === "Metals" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer-sc"
                    id="up-and-down-boxes-changer-mobile-metals"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">2 Cents</h3>
                      <span data-aos="fade-down">Tightest spreads on Gold</span>
              ...
              {activeButton === "Shares" && (
                <div className="content-shares">
                  ...
                  <p data-aos="fade-down">
                    Purchase and sell shares of more than 20,000 of the biggest
                    global corporations' stocks that are listed on the world's
                    leading stock exchanges according to market capitalization,
                    with as little as 5% margin.
                  </p>
                  <div
                    className="up-and-down-boxes-changer-sc"
                    id="up-and-down-boxes-changer-web-shares"
                  >
                    <div className="up-and-down-box-changer">
              ...
              {activeButton === "Shares" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer-sc"
                    id="up-and-down-boxes-changer-mobile-shares"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">20,000+</h3>
                      <span data-aos="fade-down">Tightest</span>
              ...
              {activeButton === "Indices" && (
                <div className="content-indices">
                  ...
                  <p data-aos="fade-down">
                    Get immediate access to and trade important global stock
                    exchange indices, such as the Dow Jones 30, German DAX 40,
                    and NASDAQ 100.
                  </p>
                  <div
                    className="up-and-down-boxes-changer-th"
                    id="up-and-down-boxes-changer-web-indices"
                  >
                    <div className="up-and-down-box-changer">
              ...
              {activeButton === "Indices" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer-th"
                    id="up-and-down-boxes-changer-mobile-indices"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">1:100</h3>
                      <span data-aos="fade-down">Leverage</span>
              ...
              {activeButton === "Commodities" && (
                <div className="content-commodities">
                  ...
                  <p data-aos="fade-down">
                    Trade commodities to diversify your portfolio, such as
                    grains and energy. To get a good return on your investment,
                    take advantage of changes in the global commodity market's
                    supply and demand..
                  </p>
                  <div
                    className="up-and-down-boxes-changer-th"
                    id="up-and-down-boxes-changer-web-commodities"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">0%</h3>
                      <span data-aos="fade-down">Commission</span>
              ...
              {activeButton === "Commodities" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer-th"
                    id="up-and-down-boxes-changer-mobile-commodities"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">0%</h3>
                      <span data-aos="fade-down">Commission</span>
              ...
              {activeButton === "Digital Assets" && (
                <div className="content-digital-assets">
                  ...
                  <p data-aos="fade-down">
                    With Forex Voyager Limited, you can invest in the most
                    well-known cryptocurrencies, such as Bitcoin, Ethereum,
                    Ripple, and others, and benefit from this market's large
                    price swings. This is best suited for seasoned traders who
                    prefer to trade aggressively.
                  </p>
                  <div
                    className="up-and-down-boxes-changer-frth"
                    id="up-and-down-boxes-changer-web-digital"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">{"<20ms"}</h3>
                      <span data-aos="fade-down">
                        Stable and nanosecond execution
                      </span>
                    </div>
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">0%</h3>
              ...
              {activeButton === "Digital Assets" && (
                <>
                  ...
                  <div
                    className="up-and-down-boxes-changer-frth"
                    id="up-and-down-boxes-changer-mobile-digital"
                  >
                    <div className="up-and-down-box-changer">
                      <h3 data-aos="fade-down">{"<20ms"}</h3>
            ...
            <div className="what-forex">
              <div className="forex-text">
                <h3 data-aos="fade-down">
                  What is <span> Forex </span>?
                </h3>
                <div className="forex-peragraph">
                  <p data-aos="fade-down">
                    Forex is the largest financial market in the world with a
                    daily turnover of approximately $7.5 Trillion. It functions
                    via an international network of banks, businesses, and
                    private citizens who exchange currencies on a regular basis.
                  </p>

                  <p data-aos="fade-down">
                    The Foreign exchange market is open around-the-clock and
                    lacks a physical presence. To find out the pertinent dates
                    and trading sessions, see our Trading Hours.
                  </p>

                  <p data-aos="fade-down">
                    With extensive liquidity, Forex Voyager provides trading in
                    major, cross, and exotic pairings on the Forex markets.
                    Enjoy the most advanced trading platforms, MetaTrader 5,
                    together with the greatest trading tools, on all of our
                    accounts.
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="trade-grid">
            <div className="start-trading">
              ...
              <p data-aos="fade-down">
                With the narrowest spreads in the market, start trading on over
                55 Forex pairs with Forex Voyager.
              </p>
            </div>
        ...
        <div className="conatiner">
          <div className="cards-grid">
            <div className="whyselectus-cards-grid-items1">
              ...
              <p data-aos="fade-down">
                Forex Voyager has one of the most competitive spreads available,
                with starting prices as low as 0.0 pip.
              </p>
            </div>
            ...
            <div className="whyselectus-cards-grid-items1">
              ...
              <p data-aos="fade-down">
                {" "}
                Users can raise their buying power with up to 1:500 leverage,
                which affects how affordable their trades are.
              </p>
            </div>
            ...
            <div className="whyselectus-cards-grid-items1">
              ...
              <p data-aos="fade-down">
                Major, minor, and exotic currency pairs are among the many
                different types of currency pairs that exist.
              </p>
            </div>
          </div>
        </div>
