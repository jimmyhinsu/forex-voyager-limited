...
export default function Deposit() {
    return (
        <div className='depositemain'>
            ...
            <div className="conatiner-deposit">
                <p>Forex Voyager fx limited (hereafter referred to as “Forex Voyager ltd”, “Forex”, ‘us’, ‘we’ and ‘our’), is Incorporated under the laws of saint lucia with registered address 1st floor, the sotheby Building,rodney bay, gros-islet,saint lucia p.O box 838,castries, saint lucia.. The company is a Licensed money brokerage reputed by labuan financial services authority.</p>
                ...
                <p>When depositing by a Bank Transfer, you are required to use only a bank account, which is in your name which should exactly match the name of the trading account. An authentic SWIFT confirmation or a Wire Transfer Confirmation, showing the origin of the funds, must be sent to our team once requested. Failure to submit the confirmation may result in the return of the deposited amount, hence preventing such pending amounts from being deposited to your Forex Voyager Limited.</p>
                ...
                <p>Funds deposit and withdrawal is only available for clients who have been identified and assessed by Forex Voyager, and their contact details are confirmed. Clients would be required to upload their supporting documents, such as a Photo ID and a Proof of an Address, and have their trading account verified in order to have their funds deposited for trading.</p>

                <p>Please note that Forex Voyager is legally required to return any Client’s deposits made into an unverified trading accounts in case the verification procedures are not completed within 15 days from the first deposit date.</p>

                <p>Upon submitting a withdrawal request you may be required to submit a further documentation as may be required from time to time by Anti Money Laundering (AML) regulations, Credit/ Debit Card companies, Electronic Payment providers and Forex Voyager Limited.</p>

                <p>Forex Voyager reserves the right to impose withdrawal limits and withdrawal fees in its system.</p>

                <p>Forex Voyager cannot accommodate withdrawal requests for floating trading profits. A trading position will need to be closed before any profits attributed to it may be withdrawn.</p>

                <div className='main-sub-name'>
                    <h2>No Third-Party Payments are allowed under any circumstances.</h2>
                </div>

                <p>This policy protects both us, and our clients against fraud and money laundering as Forex Voyager FXonly transfers funds back to the source of the original deposit. Forex Voyager, at its sole discretion, may execute withdrawals to a facility other than the facility used for the original deposit.</p>

                <p>Forex Voyager reserves the right to require the client withdrawal method on the Forex Voyager’s discretion.</p>

                <p>Clients shall request, under all circumstances, to withdraw funds from their trading accounts inthe currency in which the deposit was originally made. Should the deposit currency differ from the transfer currency, the transfer amount will be converted by Forex Voyager into the transfer currency.</p>
                ...
                <p>All complaints must be in writing and addressed to the Customer Support team of the Company via email at <a href="mailto:Info@forexVoyager.com" target='_blank' rel="noreferrer">Info@forexVoyager.com</a></p>
